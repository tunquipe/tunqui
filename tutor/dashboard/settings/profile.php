        ...
        <div class="tutor-row">
            <div class="tutor-col-12 tutor-col-sm-6 tutor-col-md-12 tutor-col-lg-6 tutor-mb-32">
                <?php
                    ...
                    $codeCountry = get_user_meta($user->ID, '_country_user', true);
                ?>
                <label class="tutor-form-label tutor-color-secondary">
            ...
            <div class="tutor-col-12 tutor-col-sm-6 tutor-col-md-12 tutor-col-lg-6 tutor-mb-32">
                <label class="tutor-form-label tutor-color-secondary">
                    <?php esc_html_e( 'Documento de identidad', 'tutor' ); ?>
                </label>
                <input class="tutor-form-control" type="text" name="dni_user" value="<?php esc_html_e( filter_var( get_user_meta( $user->ID, '_dni_user', true ), FILTER_SANITIZE_NUMBER_INT ) ); ?>" placeholder="<?php esc_attr_e( 'Phone Number', 'tutor' ); ?>">
            </div>
        </div>
