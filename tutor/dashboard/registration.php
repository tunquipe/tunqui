...
<?php do_action('tutor_before_student_reg_form');?>
    <div class="row">
        ...
        <div class="col-12 col-md-7">
            <h2>¡Comencemos!</h2>
            <p>Ya tienes una cuenta, <a href="#">Identificate</a></p>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="tutor-form-group">
                            ...
                            <input type="text" name="dni_user" value="<?php echo tutor_utils()->input_old('dni_user'); ?>" placeholder="(C.C/DNI/RUT/RFC/CURP)">
                        </div>
                    </div>
                </div>
